...
!function(a){
	...
	c={json:"JSON",xml:"XML",png:"PNG",csv:"CSV",txt:"TXT",sql:"SQL",doc:"MS-Word",excel:"MS-Excel",xlsx:"MS-Excel (OpenXML)",
	powerpoint:"MS-Powerpoint",pdf:"PDF"};
	...
	a.extend(a.fn.bootstrapTable.locales,{
		formatExport:function(){return"Export data"}}),
			...
			if(!g.length){
				...
				h.find("li").click(function(){
					...
					if("all"===d.options.exportDataType&&d.options.pagination)
						d.$el.one("server"===d.options.sidePagination?"post-body.bs.table":"page-change.bs.table",
						            function(){e&&d.hideColumn(e),c(),d.togglePagination()}
						),
						d.togglePagination();
						...
						if("server"===d.options.sidePagination){
							...
							h[d.options.dataField]=f,
							f=h;
							var i={total:g.length};
							i[d.options.dataField]=g,
							g=i
						}
						d.load(g),
						e&&d.hideColumn(e),
